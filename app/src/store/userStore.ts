  ...
  updateUser: async (updates) => {
    ...
    try {
      ...
      await networkService.performWithOfflineFallback(
        ...
        // Offline fallback
        async () => {
          console.log('User update queued for offline sync');
        },
        'update_user',
        updatedUser
      );
    ...
    try {
      const newUser: UserProfile = {
        ...
        notifications: {
          ...
          morning: userData.notifications?.morning ?? '08:00',
          midday: userData.notifications?.midday ?? '13:00',
          evening: userData.notifications?.evening ?? '20:00'
        },
        preferences: {
