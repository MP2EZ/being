/**
 * DEBUG-628 — the Reflection Timer toggle must never share screen space with the crisis
 * FAB's touch band.
 *
 * ReflectionTimer is in IMMERSIVE_ROUTES, which renders the FAB faded — NOT absent.
...
const TOGGLE = 'reflection-timer-screen-toggle-button';
const VIEWPORTS = [
...
const SOURCE = path.resolve(__dirname, '../ReflectionTimerScreen.tsx');
