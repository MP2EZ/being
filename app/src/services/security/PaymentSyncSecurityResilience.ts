...
export class PaymentSyncSecurityResilienceService {
  ...
  // Secure storage keys
  private readonly RESILIENCE_CONFIG_KEY = '@fullmind_resilience_config_v1';
  private readonly CRYPTOGRAPHIC_STATE_KEY = '@fullmind_crypto_state_v1';
  private readonly SECURITY_EVENTS_KEY = '@fullmind_security_events_v1';
  private readonly RECOVERY_OPERATIONS_KEY = '@fullmind_recovery_ops_v1';
