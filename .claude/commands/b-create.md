...
- Time Criticality: 5=Critical Blocker, 4=Hard Deadline, 3=Target Window, 2=Opportunistic, 1=No Deadline
...
- Time Criticality: [score] - [rationale]
...
- Time Criticality: [AGREE / ADJUST to X because...]
...
- Time Criticality: [final score] - [rationale, note if adjusted]
...
- Time Criticality: [final score] - [rationale]
...
- Scores: Impact, Value, Strategic Fit, Time Criticality, Effort, Risk
...
- Priority Score calculated by Notion formula: `(I × V^1.5 × SF × TC) / (E × R)`
