...
└── .claude/
    ...
    └── agents/             # Project-specific agents
        └── project/        # Being.-specific agents
```

## Key Being. Files & Patterns
...
## Common Being. Development Workflows
...
## Being. Agent Integration Patterns
...
This guide provides concrete examples of using the agent framework specifically for Being. development, ensuring that both therapeutic and technical concerns are properly addressed.