...
const ProfileScreen: React.FC = () => {
  ...
  const handleExportData = async () => {
    try {
      ...
      Alert.alert(
        'Data Export Ready',
        `Your data export (${(jsonString.length / 1024).toFixed(1)} KB) is ready.`,
        [
          {
          ...
          },
          {
            ...
            onPress: async () => {
              try {
                ...
                const fileName = `fullmind-export-${new Date().toISOString().split('T')[0]}.json`;
                ...
                if (await Sharing.isAvailableAsync()) {
                  await Sharing.shareAsync(fileUri, {
                    ...
                    dialogTitle: 'Share FullMind Data Export'
                  });
                } else {
                  Alert.alert('Sharing not available', 'Please copy to clipboard instead.');
                }
              } catch (error) {
