/**
 * Version 2: Compact Professional (Cerebral-style)
 * - Tighter spacing, more content density
...
export default function V2() {
  return (
    <div className="bg-white">
      {/* Hero - Compact but clear */}
      <section className="px-6 py-16 sm:py-24">
        <div className="max-w-4xl mx-auto text-center">
          <BrainIcon size={48} className="text-gray-800 mb-8 mx-auto" />
          <h1 className="text-4xl sm:text-5xl font-semibold text-gray-900 mb-4 leading-tight">
            Mindfulness with meaning
          </h1>
          <p className="text-lg text-gray-600 mb-8 mx-auto max-w-2xl leading-relaxed">
      ...
      {/* Three Pillars - Efficient spacing */}
      ...
      {/* Download CTA - Clean and concise */}
      <section className="px-6 py-16 bg-white border-t border-gray-200">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-2xl sm:text-3xl font-semibold text-gray-900 mb-4">Ready to begin?</h2>
