...
import { PostgrestClient } from 'https://esm.sh/@supabase/postgrest-js@1.17.11/dist/cjs/index.d.ts';
import { RealtimeChannel, RealtimeChannelOptions, RealtimeClient } from 'https://esm.sh/@supabase/realtime-js@2.11.3/dist/module/index.d.ts';
