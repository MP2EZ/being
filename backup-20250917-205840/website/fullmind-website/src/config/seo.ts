/**
 * FullMind Website - SEO Configuration
...
export const baseSEO: Metadata = {
  ...
  authors: [
    {
      name: 'FullMind Clinical Team',
      url: 'https://fullmind.app/about'
    }
  ],
  creator: 'FullMind',
  publisher: 'FullMind',
  applicationName: 'FullMind',
  ...
  openGraph: {
    ...
    title: 'FullMind - Clinical-Grade Mental Health Support',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'FullMind - Clinical-Grade Mental Health Support',
        type: 'image/jpeg'
      }
    ]
  },
...
export const pageSEO = {
  home: {
    title: 'Clinical-Grade Mental Health Support | FullMind',
  ...
  features: {
    ...
    description: 'Discover FullMind\'s clinical-grade features: validated assessments (PHQ-9, GAD-7), MBCT practices, mood tracking, and 24/7 crisis support.',
    keywords: [
  ...
  clinical: {
    ...
    description: 'FullMind is built on 20+ years of MBCT research. Clinically validated assessments, evidence-based practices, and proven therapeutic outcomes.',
    keywords: [
      'clinical evidence',
      'MBCT research',
      'evidence-based therapy',
  ...
  therapists: {
    ...
    description: 'Professional tools for therapists: patient progress monitoring, clinical dashboards, crisis alerts, and outcome tracking. Enhance your practice with FullMind.',
    keywords: [
      'therapist tools',
      'patient monitoring',
      'clinical dashboard',
  ...
  privacy: {
    ...
    description: 'FullMind protects your mental health data with clinical-grade security. HIPAA-ready privacy practices and transparent data handling.',
    keywords: [
      'privacy policy',
  ...
  terms: {
    title: 'Terms of Service - FullMind Clinical Application',
    description: 'Terms of service for FullMind clinical mental health application. Professional standards and user responsibilities.',
    keywords: [
      'terms of service',
...
export const structuredData = {
  organization: {
    ...
    sameAs: [
      'https://twitter.com/fullmindapp',
      'https://linkedin.com/company/fullmind',
      'https://github.com/fullmind-app'
    ]
  },
  ...
  medicalWebPage: {
    '@context': 'https://schema.org',
    '@type': 'MedicalWebPage',
    name: 'FullMind - Clinical Mental Health Support',
  ...
  faqPage: {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'Is FullMind clinically validated?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Yes, FullMind is built on 20+ years of MBCT research and uses clinically validated assessments like PHQ-9 and GAD-7.'
        }
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'FullMind provides immediate access to crisis resources including the National Suicide Prevention Lifeline (988) and Crisis Text Line (741741).'
        }
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Yes, FullMind uses clinical-grade security and is built with HIPAA-ready privacy practices to protect your mental health data.'
        }
      }
    ]
  }
...
export function generateCrisisSEO(): Metadata {
  return {
    title: '24/7 Crisis Support - Immediate Mental Health Help | FullMind',
