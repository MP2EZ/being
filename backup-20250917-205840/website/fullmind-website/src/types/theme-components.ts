/**
 * FullMind Website - Theme Component Integration Types
...
/**
 * Enhanced theme-aware props for FullMind components
 */
export interface FullMindThemeProps extends ThemeAwareProps {
...
/**
 * Clinical component theme requirements for FullMind
 */
export interface FullMindClinicalProps extends ClinicalThemeProps {
...
/**
 * Performance-aware theme props for FullMind
 */
export interface FullMindPerformanceProps extends PerformanceThemeProps {
 ...
 */
export interface HeaderThemeProps extends FullMindThemeProps {
 ...
 */
export interface FooterThemeProps extends FullMindThemeProps {
 ...
 */
export interface NavigationThemeProps extends FullMindThemeProps {
 ...
 */
export interface HeroThemeProps extends FullMindThemeProps {
 ...
 */
export interface FeaturesThemeProps extends FullMindThemeProps {
 ...
 */
export interface ClinicalThemeProps extends FullMindThemeProps {
 ...
 */
export interface TrustIndicatorsThemeProps extends FullMindThemeProps {
 ...
 */
export interface ButtonThemeProps extends FullMindThemeProps {
 ...
 */
export interface CardThemeProps extends FullMindThemeProps {
 ...
 */
export interface ModalThemeProps extends FullMindThemeProps {
 ...
 */
export interface InputThemeProps extends FullMindThemeProps {
 ...
 */
export interface CrisisButtonThemeProps extends FullMindClinicalProps {
 ...
 */
export interface AssessmentThemeProps extends FullMindClinicalProps {
 ...
 */
export interface BreathingSpaceThemeProps extends FullMindClinicalProps {
 ...
 */
export interface PerformanceDashboardThemeProps extends FullMindPerformanceProps {
  readonly metricsTheme?: {
 ...
 */
export interface LoadingThemeProps extends FullMindThemeProps {
 ...
 */
export interface ErrorBoundaryThemeProps extends FullMindThemeProps {
  readonly errorTheme?: {
    readonly background: HexColor;
    readonly foreground: HexColor;
    readonly border: HexColor;
 ...
 */
export interface SkipLinksThemeProps extends FullMindThemeProps {
 ...
 */
export interface ScreenReaderThemeProps extends FullMindThemeProps {
 ...
 */
export interface DownloadButtonsThemeProps extends FullMindThemeProps {
 ...
 */
export interface PhoneMockupThemeProps extends FullMindThemeProps {
 ...
 */
export interface TypographyThemeProps extends FullMindThemeProps {
 ...
 */
export interface SectionThemeProps extends FullMindThemeProps {
 ...
 */
export interface ContainerThemeProps extends FullMindThemeProps {
 ...
 */
export type WithThemeProps<T> = T & FullMindThemeProps;
...
) => React.ComponentType<TProps & FullMindThemeProps>;
