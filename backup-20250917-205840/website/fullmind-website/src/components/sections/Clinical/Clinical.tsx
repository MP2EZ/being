      ...
      <Container>
        ...
        <div className="text-center mb-16">
          ...
          <Typography 
            ...
            element="p"
          >
            FullMind is built on the proven foundation of Mindfulness-Based Cognitive Therapy (MBCT), 
        ...
        <div className="bg-gradient-to-r from-gray-50 to-clinical-safe/5 rounded-2xl p-8 lg:p-12">
          <div className="text-center mb-8">
            ...
            <Typography 
              ...
              element="p"
            >
              FullMind meets the highest standards for mental health technology and 
