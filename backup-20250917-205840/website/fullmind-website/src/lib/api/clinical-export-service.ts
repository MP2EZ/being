/**
 * FullMind Clinical Export Service API - Implementation Architecture
 * 
 ...
 * - Seamless integration with existing FullMind data infrastructure
 */
...
/**
 * FullMind data integration service
 */
export interface FullMindDataIntegration {
