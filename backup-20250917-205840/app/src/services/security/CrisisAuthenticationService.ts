...
export class CrisisAuthenticationService {
  ...
  // Storage keys
  private readonly CRISIS_SESSIONS_KEY = '@fullmind_crisis_sessions_v1';
  private readonly CRISIS_HISTORY_KEY = '@fullmind_crisis_history_v1';
  private readonly CRISIS_CONFIG_KEY = '@fullmind_crisis_config_v1';
  private readonly EMERGENCY_CONTACTS_KEY = '@fullmind_emergency_contacts_v1';
