...
export class SecurityControlsService {
  ...
  // Storage keys
  private readonly AUDIT_LOG_KEY = '@fullmind_audit_log_v1';
  private readonly SECURITY_CONFIG_KEY = '@fullmind_security_config_v1';
  private readonly THREAT_DATA_KEY = '@fullmind_threat_data_v1';
