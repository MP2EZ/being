...
export class FeatureFlagManager {
  ...
  // Secure storage keys
  private readonly FEATURE_FLAGS_KEY = '@fullmind_feature_flags_v1';
  private readonly FEATURE_FLAGS_PROFILE_KEY = '@fullmind_feature_profile_v1';
  private readonly FEATURE_FLAGS_AUDIT_KEY = '@fullmind_feature_audit_v1';
  private readonly CRISIS_SAFETY_KEY = '@fullmind_crisis_safety_v1';
