/**
 * FullMind Clinical Export Demo Component
 * 
...
const generateMockConsent = (): UserConsentRecord => ({
  ...
  recipientInformation: {
    ...
    organization: 'FullMind Therapy Partners',
...
const generateMockExportResult = (config: ClinicalExportOptions): ExportResult => ({
  ...
  downloadUrl: 'https://demo.fullmind.io/exports/secure-download',
    ...
    >
      ...
      <div className="text-center">
        ...
        <Typography variant="body1" className="text-text-secondary">
          Interactive demonstration of FullMind's therapeutic-grade data export workflow
        </Typography>
      </div>
