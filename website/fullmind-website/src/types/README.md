# FullMind Website - TypeScript Type Definitions

## Overview

This directory contains comprehensive TypeScript type definitions for the FullMind website, designed to provide clinical-grade type safety and seamless integration with the React Native app ecosystem.
...
For questions about type usage or clinical validation requirements, consult the clinical and technical documentation in the main FullMind repository.