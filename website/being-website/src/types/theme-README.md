# Being. Dark Mode Theme System - TypeScript Types

## Overview

This comprehensive TypeScript type system provides clinical-grade dark mode implementation for the Being. mental health platform. The system is designed with strict type safety, accessibility compliance (WCAG AA/AAA), performance optimization, and clinical safety requirements.
...
```typescript
import { ThemeComponentFactory, Being.ThemeProps } from '@/types';
...
- `Being.ThemeProps` - Base theme-aware props
...
interface MyComponentProps extends Being.ThemeProps {
  title: string;
  clinical?: boolean;
}
...
const clinicalProps: Being.ClinicalProps = {
  clinicalGrade: true,
  mbctCompliant: true,
