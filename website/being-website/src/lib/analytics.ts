/**
 * Being. Website - Analytics & Performance Monitoring
...
export class PrivacyCompliantAnalytics {
  ...
  private initializeConsent(): void {
    ...
    const storedConsent = localStorage.getItem('being-analytics-consent');
  ...
  public setConsent(granted: boolean): void {
    ...
    if (typeof window !== 'undefined') {
      localStorage.setItem('being-analytics-consent', granted.toString());
    }
