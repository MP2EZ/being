/**
 * Being. React Native PDF Generator - Clinical Report Generation
 * 
...
<head>
    ...
    <title>Being. Clinical Report</title>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Being. Progress Summary</title>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Being. Assessment Timeline</title>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Being. Crisis Safety Plan</title>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Being. Therapeutic Charts</title>
  ...
  async generatePDFFromHTML(html: string, options: PDFGenerationOptions): Promise<PDFGenerationResult> {
    try {
      ...
      const pdfResult = await RNHTMLtoPDF.convert({
        html: styledHTML,
        fileName: options.fileName || 'being-clinical-report',
    ...
    return `
      <header class="clinical-header">
        <div class="clinic-logo">
          <div class="clinic-name">Being. MBCT</div>
        </div>
  ...
  private generateClinicalFooter(date: string): string {
    return `
      <footer class="clinical-footer">
        <p>Generated on ${date} by Being. Clinical Export System</p>
