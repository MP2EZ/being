/**
 * Being. Website - Shared Constants
...
export const ENVIRONMENT = {
  ...
  STAGING: {
    API_BASE_URL: 'https://staging-api.being.app',
    ANALYTICS_DEBUG: false,
    PERFORMANCE_BUDGET_STRICT: true
  },
  
  PRODUCTION: {
    API_BASE_URL: 'https://api.being.app',
    ANALYTICS_DEBUG: false,
    PERFORMANCE_BUDGET_STRICT: true
  }
} as const;
...
export const CONTENT = {
  ...
  CLINICAL_DISCLAIMER: 'Being. is not a replacement for professional mental health treatment. Please consult with a healthcare provider.',
  
  ACCESSIBILITY_STATEMENT: 'Being. is committed to digital accessibility for people with disabilities.',
...
export const ERROR_MESSAGES = {
  ...
  MAINTENANCE: 'Being. is temporarily unavailable for maintenance. Please try again shortly.'
} as const;
...
export const SUCCESS_MESSAGES = {
  ...
  NEWSLETTER_SUBSCRIBED: 'Welcome! You\'ll receive updates about Being.\'s clinical features.',
  WAITLIST_JOINED: 'You\'re on the list! We\'ll notify you when Being. becomes available.',
  CONTACT_SENT: 'Your message has been sent. Our team will respond soon.',
  FEEDBACK_SUBMITTED: 'Thank you for your feedback. It helps us improve Being.'
} as const;
