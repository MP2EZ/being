/**
 * Being. Website - Theme Integration Tests
...
describe('Theme Integration', () => {
  ...
  describe('LocalStorage Persistence', () => {
    test('persists theme preferences to localStorage', async () => {
      ...
      await waitFor(() => {
        const stored = mockLocalStorage.getItem('being-theme-preferences');
    ...
    test('loads theme preferences from localStorage on initialization', async () => {
      ...
      mockLocalStorage.setItem('being-theme-preferences', JSON.stringify(mockPreferences));
