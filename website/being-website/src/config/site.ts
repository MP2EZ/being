/**
 * Being. Website - Site Configuration
...
export const siteConfig: SiteConfig = {
  ...
  url: 'https://being.app',
  ogImage: 'https://being.app/og-image.jpg',
  links: {
    appStore: 'https://apps.apple.com/app/being',
    playStore: 'https://play.google.com/store/apps/details?id=com.being.app',
    github: 'https://github.com/being-app',
    support: 'mailto:support@being.app'
  },
  trial: trialConfig
} as const;
...
export const testimonials = [
  {
    ...
    name: 'Sarah M.',
    role: 'App User',
    content: 'Being. helped me recognize and change my thought patterns. The breathing exercises became my go-to tool during anxiety attacks.',
    rating: 5,
    verified: true
  },
  {
  ...
  },
  {
    ...
    name: 'Michael R.',
    role: 'App User',
    content: 'After struggling with depression for years, Being.\'s daily check-ins helped me track my mood and see real progress.',
    rating: 5,
    verified: true
  }
] as const;
...
export const primaryTherapistTestimonial = {
  ...
  content: 'Being. represents a breakthrough in digital mental health. The clinical accuracy of their assessments and the faithful implementation of MBCT principles make this the first app I confidently recommend to my patients.',
