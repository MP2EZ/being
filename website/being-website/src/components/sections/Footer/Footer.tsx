  ...
  return (
    <div>
      ...
      <Link 
        ...
        aria-label="Being. - Return to homepage"
      >
      ...
      <div>
        ...
        <div className="flex space-x-4">
          {[
            { name: 'Twitter', icon: TwitterIcon, url: 'https://twitter.com/being' },
            { name: 'LinkedIn', icon: LinkedInIcon, url: 'https://linkedin.com/company/being' },
            { name: 'GitHub', icon: GitHubIcon, url: 'https://github.com/being-app' }
            ...
            <a
              ...
              aria-label={`Follow Being. on ${name}`}
            >
      ...
      <Container>
        <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
          ...
          <Typography variant="caption" className="text-text-tertiary theme-transition">
            © {new Date().getFullYear()} Being. All rights reserved.
          </Typography>
