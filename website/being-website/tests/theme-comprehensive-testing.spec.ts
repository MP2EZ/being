/**
 * Being. Website - Comprehensive Dark Mode Testing Suite
...
test.describe('Being. Dark Mode - Comprehensive Testing Suite', () => {
  ...
  test.describe('2. Persistence and State Management', () => {
    ...
    test('should handle localStorage corruption gracefully', async () => {
      ...
      await page.evaluate(() => {
        localStorage.setItem('being-theme-preferences', 'invalid-json{');
      });
